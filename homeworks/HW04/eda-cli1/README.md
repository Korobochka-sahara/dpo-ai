https://github.com/Korobochka-sahara/dpo-ai/tree/main/homeworks/HW05# S03 – eda_cli: мини-EDA для CSV
...
Для запуска HTTP сервера используйте uvicorn:
...
Загружает CSV и возвращает все эвристические флаги качества, включая новые из HW03.
